        ...
        $.get(`https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=14&playlistId=${playListId}&key=${API_KEY}`,
            function (data) {
                $.each(data.items, function (i, item) {
                    ...
                    let output = `<div style='display:inherit'> <iframe width="180px" height="auto" src="https://www.youtube.com/embed/${videoId}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>`
